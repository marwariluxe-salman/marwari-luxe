...
const SocialMediaPage = () => {
  const socialMediaLinks = [
    ...
    { name: 'LinkedIn', url: 'https://linkedin.com/company/marwariluxe', icon: <LinkedInIcon />, color: 'bg-blue-700 hover:bg-blue-800' },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {socialMediaLinks.map((platform, index) => (
            ...
            >
              ...
              >
                <div className={`${platform.color} p-6 flex flex-col items-center justify-center text-white transition-colors duration-300`}>
                  <div className="mb-3">
                    {platform.icon}
                  </div>
                ...
                <div className="p-4 text-center">
                  <p className="text-purple-600 font-medium">Follow Us</p>
                </div>
              </a>
            </motion.div>
          ))}
